...
namespace ARS
{
    ...
    public class ARS : Script
    {
        ...
        public static List<Model> RacerModels = new List<Model> { "a_m_y_motox_01", "a_m_y_motox_02", }; // "S_M_M_RaceOrg_01", "IG_Hao", "IG_Hao_02"
        ...
        void HandleMenu()
        {
            ...
            if (Game.IsControlJustPressed(Control.FrontendAccept))
            {
                if (oSelected == Options.ReloadSettings)
                {
                    ...
                    LoadSettings();
                    Notification.Show("Reloaded setting files");
                }
                ...
                if (oSelected == Options.Start)
                {
                    ...
                    {
                        Notification.Show("~r~No track selected.");
                    }
                }
                ...
                if (RaceStatus == RaceState.None)
                {
                    for (int i = 0; i < ImmersiveJoins.Count; i++)
                    {
                        if (Game.Player.Character.IsInRange(ImmersiveJoins.ElementAt(i).Key, 50f))
                        {
                            ...
                            Notification.Show("added" + ImmersiveJoins.ElementAt(i).Value);
                        }
                    }
                }
            }
        ...
        void LoadRace(string track, string disciplines, int gridSize)
        {
            ...
            {
                Notification.Show("Track does not exist.");
                return;
            }
        ...
        */
        ...
        void PlaceCars(bool sortbypower)
        {
            ...
            {
                Notification.Show("Cops 'n' Crooks detected");
        ...
        public void SpawnTrackLimits(List<Vector3> nodes, Dictionary<int, float> widedict, int fidelity)
        {
            ...
            Notification.Show("Track stats:~n~~b~Track Length: ~w~" + length + " Km ~n~(" + miles + " Miles).~n~Road: " + PercentRoad + "%~n~Dirt: " + PercentDirt + "% ~n~Other: " + PercentOther + "% ");
        }
        ...
        public void Cheats()
        {
            ...
            if (WasCheatStringJustEntered("arscarlisten"))
            {
                ...
                if (listenmode) Notification.Show("~g~Listen mode is on."); else Notification.Show("~y~Listen mode disabled.");
            }
            ...
            {
                Notification.Show("Re loading settings.");
                SettingsFile = null;
                DevSettingsFile = null;
                LoadSettings();
            }
        ...
        public void UpdateRoute(bool path, bool raceline, bool props)
        {
            ...
            if (path || raceline)
            {
                Notification.Show("Updating path and raceline.");
            ...
            if (props)
            {
                Notification.Show("Updating objects.");
                XmlElement info = null;
        ...
        public void LoadTrack(XmlDocument xmlFile)
        {
            ...
            if (xmlFile == null)
            {
                Notification.Show("~r~Invalid track file.");
                return;
            }
            ...
            {
                RouteNodes.Reverse();
                Notification.Show("~g~Route is reversed.");
            }
        ...
        void LoadSettings()
        {
            ...
            else
            {
                ...
                Notification.Show("~o~Failed to load the Options file.~w~ Check you've installed ARS properly.");
            }
            ...
            else
            {
                ...
                Notification.Show("~o~Failed to load the Settings file.~w~ Check you've installed ARS properly.");
            }
            ...
            else
            {
                ...
                Notification.Show("~o~Failed to load the MemoryOffsets file.~w~ Check you've installed ARS properly.");
            }
